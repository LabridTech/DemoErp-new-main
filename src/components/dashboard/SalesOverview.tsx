  ...
  return (
    <div className="space-y-3 sm:space-y-4">
      ...
      <div className="space-y-2 max-h-[220px] sm:max-h-[300px] overflow-y-auto pr-2">
        {data.map((item) => (
          <div key={item.name} className="flex items-center space-x-2 sm:space-x-4">
            <div className="w-12 sm:w-16 text-xs sm:text-sm font-medium truncate" title={item.name}>{item.name}</div>
            <div className="flex-1">
              <div className="flex items-center space-x-1.5 sm:space-x-2">
                ...
                <div className="w-14 sm:w-20 text-xs sm:text-sm text-right">
